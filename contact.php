...
try
{
    ...
    $emailTextHtml .= "<h3>New message from Rocoto Peruvian & Mexican Grill Website:</h3><hr>";
    $emailTextHtml .= "<table>";
    ...
    $emailTextHtml .= "<p>Have a great day!<br><br>Sincerely,<br><br>Your Web Developer, Cesar Alcantara</p>";
